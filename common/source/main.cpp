...
int main(int argc, char** argv)
{
	...
	Simulation::caseName = "r0_120_80_16_15degree_case5";
	...
	//Simulation::specific_data = "C:/C++/result/r30_110_80_14_15degree_case4_start.dat";
	...
	cube_boundary->define(vector3<double>(1.0, 0.5, 0.4), vector3<double>(0.0, 0.0, 0.0), ACRYLIC, BOUNDARY);
 	...
 	shape_trawl->define("C:/C++/case/dem/r0_120_80_16.dat", vector3<double>(0.85, 0.08, 0.2), STEEL, MASS);
	...
	forceCalculator::OnGravityForce = true;
	pointmass::OnMoving = false;
	if(!dem->initialize()){
